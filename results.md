...
全量单次检索与 Gemma QA 已迁至 GPU 作业 `6513034`，冻结两项事实评分，使用原单次 QA 的五条出处上限，与原 BM25、HippoRAG 2 同次重新 QA，覆盖六任务全部 3386 题。当前是候选验证，尚无全量成绩；不把前面六条预算的预检表当作这批结果。具体协议见 `research_plan.md`。
