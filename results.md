...
四 reader 的三条件预检 `6525861` 已提交，依赖全量 `6525863` 只在全部预检通过后执行，共 12000 条预测。一张 L40S、单 CPU，reader 串行；输出目录为 `optimization_gold_evidence_seed42_20260919`。目前没有 gold-only QA 分数，其他五任务的主实验范围不变，不额外制造证据标注。
